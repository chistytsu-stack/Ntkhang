...
- **[API Reference](API_REFERENCE.md)** - Complete API documentation with all available methods
- **[Theme Features](THEME_FEATURES.md)** - Comprehensive guide to theme management
- **[Bot Testing](BOT_TESTING.md)** - Test bot examples and available commands
- **[Changelog](CHANGELOG.md)** - Version history and updates
- **[Publishing Guide](PUBLISHING.md)** - How to publish this library to npm
...
This library includes a comprehensive test bot to verify functionality. See **[BOT_TESTING.md](BOT_TESTING.md)** for detailed documentation.

### Running the Test Bot

```bash
# Make sure you have appstate.json configured
npm run bot
```

The test bot includes commands for:
- Basic messaging (`/ping`, `/echo`, `/test`)
- Theme management (`/theme`, `/theme ai`, `/theme list`)
- Thread operations (`/threadinfo`, `/userinfo`, `/history`)
- Group management (`/emoji`, `/nickname`, `/threadname`)
- And more! Type `/help` in a conversation to see all commands.

### Validation Tests

Run validation tests before publishing:
...
- `npm run bot` - Start the test bot
- `npm run pack:dry` - Test package contents (dry run)
- `npm run pack:test` - Create package and inspect contents
